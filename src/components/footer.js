...
import FooterLogo from '../assets/img/icon-logo/logo.svg';
			...
			<div className="container">
				<div className="columns navlist-footer-column">
					<div className="column text-center trademark-heading">
						...
						<p>
							Barbara Floyd loves to hear from readers. You can reach her via email. Feel free to send
							questions about writing, her works, interviews and other publicity matters.
						</p>
					</div>
				...
				<div className="columns">
					...
					<div className="column text-center trademark-heading">
						<nav id="style_soc_medias">
							...
							<a
								href="https://www.goodreads.com/book/show/55424551-toys"
								target="_blank"
								rel="noopener noreferrer"
							>
